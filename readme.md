...
### discussion
Using ResNet50 with image 0 with 20 epochs received a root mean square error score of 0.00707. Unexpectedly, using image 0 performed better than using ResNet50 with image 0, 1, 2. since it learned from not only one view of the robot hand, but three different views.
